...
// 					noscroll, 
// 					isAnimating,
// 					container = document.getElementById( 'containero' ),
...
function init_functions_content(){
    ...
    //console.log( "/assets/videos/cloud.mp4");
...
//   $( ".perfil-tipo" ).html( htmlString );
//   $( ".dropdown" ).toggleClass( "open" );
// });

// // jQuery Ocultar y mostrar div logo
// $('#alternar-respuesta').click(function(){
//   $('#respuesta').toggle('slow');
//   // var htmlString = $( "#oculto-icono2" ).html();
//   // $( "#alternar-respuesta" ).html( htmlString );
// });
...
(function (e) {
    e.backgroundVideo = function (t, n) {
        ...
        var o = function () {
            ...
            //html for mp4 video//
            t += '<source src="' + "/assets/videos/cloud.mp4"+ '" type="video/mp4" />';
            //script for ogg video//
            t += '<source src="' + "/assets/videos/cloud.ogg"+ '" type="video/ogg" />';
            //script for webm video//
            t += '<source src="' + "/assets/videos/cloud.webm"+ '" type="video/webm" />';

            //for (var n = 0; n < i.settings.types.length; n++) {
            	//"/videos/cloud."+i.settings.types[n]" +"
