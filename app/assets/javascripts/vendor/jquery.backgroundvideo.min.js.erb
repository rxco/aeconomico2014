...
(function (e) {
    e.backgroundVideo = function (t, n) {
        ...
        var o = function () {
            ...
            //html for mp4 video//
            t += '<source src="' + "<%= asset_path('videos/cloud.mp4') %>"+ '" type="video/mp4" />';
            //script for ogg video//
            t += '<source src="' + "<%= asset_path('videos/cloud.ogg') %>"+ '" type="video/ogg" />';
            //script for webm video//
            t += '<source src="' + "<%= asset_path('videos/cloud.webm') %>"+ '" type="video/webm" />';

            //for (var n = 0; n < i.settings.types.length; n++) {
            	//"<%= asset_path('videos/cloud."+i.settings.types[n]" +') %>"
